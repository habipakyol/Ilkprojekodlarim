...
public class BasicB : MonoBehaviour
{
    ...
    public CameraController GetCamScript { get { return camScript; } }
    ...
    void Awake()
    {
        ...
        camScript = playerCamera.GetComponent<CameraController>();
...
public abstract class GenericBehaviour : MonoBehaviour
{
    ...
    protected BasicB behaviourManager;   
    ...
    void Awake()
    {
        ...
        behaviourManager = GetComponent<BasicB>();
